...
var trending = [
    {
        id: 1,
        name: "Sushi",
        image: "../resources/food/21.png",
        video: "https://www.youtube.com/embed/joweUxpHaqc?si=5AwAdWaKbnFHI30_",
        price: "70.00",
        related_to: "Japan Cuisine",
        description: "Sushi is a traditional Japanese dish consisting of vinegared rice combined with various ingredients such as raw fish, seafood, vegetables, and sometimes tropical fruits. It is often served with soy sauce, wasabi, and pickled ginger",
    ...
    },
    {
        id: 2,
        name: "Pad Thai",
        image: "../resources/food/22.png",
        video: "https://www.youtube.com/embed/BXUBhqMJrLs?si=eCRmypEkTCRQDyVG",
        price: "30.00",
        related_to: "Thailand Cuisine",
        description: "Pad Thai is a popular Thai stir-fried noodle dish made with rice noodles, tofu, shrimp or chicken, eggs, peanuts, bean sprouts, and a tangy sauce made from tamarind, fish sauce, garlic, and lime. It's often garnished with lime wedges and cilantro",
        chef_name: "Maria Sanchez",
        chefId: 1
    },
        ...
        id: 3,
        name: "Paella",
        image: "../resources/food/23.png",
        video: "https://www.youtube.com/embed/vNBuXsTY15E?si=1FGu3g1_rBka45kZ",
        price: "150.00",
        related_to: "Spain Cuisine",
        description: "Paella is a Spanish rice dish originating from Valencia. It typically contains a variety of ingredients such as saffron-infused rice, seafood (like shrimp, mussels, and clams), chicken, chorizo sausage, and vegetables like bell peppers and peas",
        ...
        id: 4,
        name: "Butter Chicken",
        image: "../resources/food/24.png",
        video: "https://www.youtube.com/embed/D_fYk8mBaF4?si=ynFKtYKdhvhB7GMp",
        price: "76.00",
        related_to: "Indian Cuisine",
        description: "Butter Chicken, also known as Murgh Makhani, is a popular Indian dish made with marinated chicken cooked in a rich and creamy tomato-based sauce. It's flavored with spices like garam masala, cumin, coriander, and finished with butter and cream",
        chef_name: "Pierre Dubois",
        chefId: 2
    },
        {
        id: 5,
        name: "Croissant",
        image: "../resources/food/25.png",
        video: "https://www.youtube.com/embed/djnNkLi_K6E?si=Kwktq-0TAbkS73GN",
        price: "90.00",
        related_to: "France Cuisine",
        description: "A flaky, buttery pastry originating from France, the croissant is made with layered dough and butter, resulting in a crispy exterior and a soft, airy interior. It's often enjoyed for breakfast or as a snack, sometimes filled with ingredients like chocolate or almond paste",
        chef_name: "Mei Chen",
        chefId: 3
    },
        {
        id: 6,
        name: "Moussaka",
        image: "../resources/food/26.png",
        video: "https://www.youtube.com/embed/cSR9GLO3Bl4?si=m0jwUzsm3dmWvdUC",
        price: "425.00",
        related_to: "Greece Cuisine",
        description: "Moussaka is a classic Greek dish consisting of layers of eggplant, minced meat (usually lamb or beef), tomatoes, onions, and a creamy béchamel sauce. It's baked until golden and bubbly, creating a hearty and flavorful casserole that's often served with a side of Greek salad and crusty bread",
        chef_name: "Mei Chen",
        chefId: 3
    },
    {
        ...
        image: "../resources/food/27.png",
        video: "https://www.youtube.com/embed/4ZJIzEeqAFw?si=ThouppJn0m8LJy09",
        price: "70.00",
        related_to: "Mexican Cuisine",
        description: "Tacos al Pastor is a Mexican street food dish made with marinated and spit-grilled pork (often with pineapple), served on corn tortillas with onions, cilantro, and salsa. The marinade typically includes achiote paste, spices, and citrus juices, giving the meat a savory and slightly tangy flavor",
